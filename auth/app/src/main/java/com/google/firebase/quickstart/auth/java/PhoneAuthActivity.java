...
public class PhoneAuthActivity extends AppCompatActivity implements
            ...
            public void onVerificationCompleted(PhoneAuthCredential cred) {
                ...
                if (cred != null) {
                    if (cred.getSmsCode() != null) {
                        mBinding.fieldVerificationCode.setText(cred.getSmsCode());  //passing the sms code to the verification field
                        Context context = getApplicationContext();
                        int duration = Toast.LENGTH_LONG;
                        Toast.makeText(context,"auto-retrieval done!",duration).show();
                    }
    ...
    private void verifyPhoneNumberWithCode(String verificationId, String code) {
        ...
        Context context = getApplicationContext();
        int duration = Toast.LENGTH_LONG;
        String text = credential.getSmsCode();
